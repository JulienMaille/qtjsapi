  ...
  a3
    ...
    class QTJSAPI_EXPORT QObject_Wrapper : public RJSWrapperObj {
    ...
    public:
      ...
      static void init(RJSApi& handler);
        ...
        static QObject* castToBase(void* vp, /*RJSType ID*/ int t) {
          ...
          // hook for modules to cast from other types to base QObject:
          ...
          // object is a pointer to base class QObject:
          if (t==RJSType_QObject::getIdStatic()) {
            return (QObject*)vp;
          }

          qWarning() << "QObject_Wrapper::castToBase: type not found: " << RJSHelper::getTypeName(t);
