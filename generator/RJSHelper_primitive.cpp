  ...
  // ----------------
      ...
      QJSValue RJSHelper::cpp2js_QInputDialog_InputDialogOptions(RJSApi& handler, QInputDialog::InputDialogOptions v) {
        return QJSValue(v);
      }

      QInputDialog::InputDialogOptions RJSHelper::js2cpp_QInputDialog_InputDialogOptions(RJSApi& handler, const QJSValue& v) {
        if (!v.isNumber()) {
      ...
      bool RJSHelper::is_QInputDialog_InputDialogOptions(RJSApi& handler, const QJSValue& v, bool acceptUndefined) {
        if (v.isUndefined() || v.isNull()) {
          return acceptUndefined;
        }
        return v.isNumber();
      ...
      QJSValue RJSHelper::cpp2js_QInputDialog_InputMode(RJSApi& handler, QInputDialog::InputMode v) {
        return QJSValue(v);
      }

      QInputDialog::InputMode RJSHelper::js2cpp_QInputDialog_InputMode(RJSApi& handler, const QJSValue& v) {
        if (!v.isNumber()) {
          return 
      ...
      bool RJSHelper::is_QInputDialog_InputMode(RJSApi& handler, const QJSValue& v, bool acceptUndefined) {
        if (v.isUndefined() || v.isNull()) {
          return acceptUndefined;
        }
        return v.isNumber();
      ...
      QJSValue RJSHelper::cpp2js_QInputDialog_InputDialogOption(RJSApi& handler, QInputDialog::InputDialogOption v) {
        return QJSValue(v);
      }

      QInputDialog::InputDialogOption RJSHelper::js2cpp_QInputDialog_InputDialogOption(RJSApi& handler, const QJSValue& v) {
        if (!v.isNumber()) {
          return 
            (QInputDialog::InputDialogOption)0
          ;
        }
        return 
      ...
      bool RJSHelper::is_QInputDialog_InputDialogOption(RJSApi& handler, const QJSValue& v, bool acceptUndefined) {
        if (v.isUndefined() || v.isNull()) {
          return acceptUndefined;
        }
        return v.isNumber();
